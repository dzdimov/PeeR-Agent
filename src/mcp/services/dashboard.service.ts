...
import {
  DASHBOARD_API_STATS_PATH,
  DASHBOARD_CATCH_ALL_PATH,
  ERROR_MESSAGES,
  SUCCESS_MESSAGES,
} from '../constants.js';

export class DashboardService {
  private state: DashboardServerState = {
    httpServer: null,
    port: null,
  };
   ...
   */
  async start(port: number, dirname: string): Promise<void> {
   ...
   */
  async startInBackground(port: number, dirname: string): Promise<void> {
    try {
