...
import { PROMPT_STEP_EMOJIS, DEFAULT_PROMPT_EMOJI, DEFAULT_PROMPT_LIMIT_VERBOSE, DEFAULT_PROMPT_LIMIT_NORMAL, INSTRUCTIONS, PEER_REVIEW_ERROR_CAUSES, ERROR_MESSAGES, } from '../constants.js';
export class FormatterService {
    /**
     * Format complete analysis output for MCP response
     */
    static formatAnalysisOutput(options) {
        const lines = [];
        // Header (verbose only)
        if (options.verbose) {
