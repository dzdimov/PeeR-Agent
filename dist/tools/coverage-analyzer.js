 ...
 */
export function detectCoverageReport(repoPath = '.') {
 ...
 */
export function parseCoverageJson(reportPath) {
    try {
 ...
 */
export function parseLcovReport(reportPath) {
    try {
        const content = fs.readFileSync(reportPath, 'utf-8');
 ...
 */
export async function runEslintAnalysis(targetPath, options = {}) {
    try {
 ...
 */
export function getCoverageAnalysis(repoPath = '.') {
 ...
 */
export async function runCoverageAnalysis(repoPath = '.', options = {}) {
 ...
 */
export function getLowCoverageFiles(analysis, threshold = 50) {
    return analysis.files.filter(f => f.metrics.lines.pct < threshold);
}
/**
 * Format coverage analysis for CLI output
 */
export function formatCoverageReport(analysis) {
 ...
 */
export function formatStaticAnalysis(analysis) {
...
function createEmptyStaticAnalysis() {
    return {
        issues: [],
