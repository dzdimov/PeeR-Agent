...
export type IssueType = 'bug' | 'feature' | 'story' | 'task' | 'epic' | 'subtask' | 'improvement' | 'spike' | 'other';
...
export type IssueTrackerType = 'jira' | 'linear' | 'azure-devops' | 'github-issues' | 'gitlab-issues' | 'shortcut' | 'asana' | 'other';
